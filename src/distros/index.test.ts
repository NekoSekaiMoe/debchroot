...
describe('Exports', () => {
	it('should export DistroHandler interface', () => {
		...
		const checkType: typeof import('./index').DistroHandler =
			{} as unknown as import('./base').DistroHandler;
		expect(checkType).toBeDefined();
	});

	it('should export DistroConfig interface', () => {
		const checkType: typeof import('./index').DistroConfig =
			{} as unknown as import('./base').DistroConfig;
		expect(checkType).toBeDefined();
	});
