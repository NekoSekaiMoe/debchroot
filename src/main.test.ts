...
import { DebianHandler, ArchHandler, AlpineHandler, FedoraHandler, OpenSUSEHandler } from './distros';
...
describe('main', () => {
  ...
  describe('input handling', () => {
    ...
    it('should handle empty packages input', async () => {
      ...
      const packagesCall = infoCalls.find((call) =>
        call[0]?.includes('Additional packages')
      );
  ...
  describe('output setting', () => {
    ...
    it('should log success message', async () => {
      ...
      expect(core.info).toHaveBeenCalledWith('✅ Successfully created debian rootfs at /home/user/rootfs');
    });
  });
  ...
  describe('full workflow with different distros', () => {
    it('should work with alpine', async () => {
      ...
      expect(core.info).toHaveBeenCalledWith('Creating alpine rootfs...');
      expect(core.info).toHaveBeenCalledWith('✅ Successfully created alpine rootfs at /home/user/rootfs');
    });
    ...
    it('should work with opensuse', async () => {
      ...
      vi.mocked(distros.getDistroHandler).mockReturnValue(mockHandler as unknown as OpenSUSEHandler);
